    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-10 offset-lg-1">
          <ul class="categories">
            <li><a href="category.html"><span class="icon"><img src="assets/images/mountain-svgrepo-com.svg" alt="Home"></span> Gunung</a></li>
            <li><a href="listing.html"><span class="icon"><img src="assets/images/beach-lounge-svgrepo-com.svg" alt="Food"></span> Pantai &amp; Pulau</a></li>
                        ...
                        <div class="thumb">
                          <div class="row">
                            <div class="col-lg-5 align-self-center">
                              <div class="left-text">
                                <h4>Salah Satu Gunung dengan Jumlah Pariwisata Terbanyak Saat Ini!</h4>
                                <p>Di Indonesia, beberapa gunung memiliki pariwisata yang sangat populer dan banyak dikunjungi oleh wisatawan. Salah satu gunung yang memiliki pariwisata yang sangat ramai adalah Gunung Bromo di Jawa Timur.</p>
                          ...
                          <div class="row">
                            <div class="col-lg-5 align-self-center">
                              <div class="left-text">
                                ...
                                <p>Di Indonesia, banyak pantai yang menjadi tujuan pariwisata populer. Salah satu pantai yang sangat terkenal dan menjadi destinasi pariwisata utama adalah Pantai Kuta, Bali</p>
                                <div class="main-white-button"><a href="#"><i class="fa fa-eye"></i> Explore More</a></div>
                              </div>
                            </div>
                            <div class="col-lg-7 align-self-center">
                              <div class="right-image">
                                <img src="assets/images/banner-bg.jpg" alt="Foods on the table">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            <div class="col-lg-5 align-self-center">
                              <div class="left-text">
                                <h4>Salah Satu Kota Bersejarah yang Terkenal Di Indonesia </h4>
                                <p>Di Indonesia, terdapat banyak tempat bersejarah yang populer dan memiliki nilai historis yang tinggi salah satunya Candi Borobudur, Jawa Tengah </p>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            <div class="col-lg-5 align-self-center">
                              <div class="left-text">
                                <h4>Salah Satu Tempat Warisan Budaya yang populer Di Indonesia</h4>
                                <p>Indonesia memiliki banyak tempat warisan budaya yang populer, mencakup situs-situs bersejarah, bangunan berarsitektur klasik, dan kebudayaan tradisional yang kaya salah satunya adalah Monumen Nasional</p>
                                <div class="main-white-button"><a href="#"><i class="fa fa-eye"></i> Discover More</a></div>
                              </div>
                            </div>
                            <div class="col-lg-7 align-self-center">
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            <div class="col-lg-5 align-self-center">
                              <div class="left-text">
                                <h4>Salah Satu Tempat resort dan spa yang populer Di Indonesia</h4>
                                <p>Beberapa resort dan spa populer di Indonesia mencakup berbagai destinasi, mulai dari pulau-pulau tropis hingga daerah pegunungan salah satunya adalah Amandara,Bali</p>
